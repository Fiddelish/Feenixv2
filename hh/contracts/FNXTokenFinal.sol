...
contract Token is ERC20, Ownable {
    ...
    address payable public StakingWallet = payable(0);//StakeWallet
    address payable public MarketingWallet = payable(0); //m wallet
    ...
    constructor() ERC20("ProjectFeenix", "FNX") {

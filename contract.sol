...
contract Token is ERC20, Ownable {
    ...
    uint256 public maxTransactionAmount =  * 10 ** 18; 
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _partnerFee, uint256 _stakingFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _partnerFee, uint256 _stakingFee) external onlyOwner {
